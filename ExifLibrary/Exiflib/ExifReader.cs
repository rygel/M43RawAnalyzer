...
namespace ExifLib
{
    ...
    public sealed class ExifReader : IDisposable
    {
        ...
        public ExifReader(string fileName, long startingOffset)
        {
            ...
            try
            {
                ...
                fileStream.Seek(startingOffset, 0);
        ...
        private void CreateTagIndex()
        {
            ...
            // Finally, catalogue the thumbnail IFD
            fileStream.Position = ifd1Offset + tiffHeaderStart;
        ...
        private byte[] GetTagBytes(Dictionary<ushort, long> tagDictionary, ushort tagID, out ushort tiffDataType, out uint numberOfComponents)
        {
            ...
            if (fileStream == null || reader == null || tagDictionary == null || !tagDictionary.ContainsKey(tagID))
            {
                tiffDataType = 0;
        ...
        private void CatalogueIFD(ref Dictionary<ushort, long> tagOffsets)
        {
            ...
            for (ushort currentEntry = 0; currentEntry < entryCount; currentEntry++)
            {
                ...
                tagOffsets[currentTagNumber] = fileStream.Position - 2;
        ...
        public byte[] GetJpegThumbnailBytes()
        {
            ...
            fileStream.Read(imageBytes, 0, (int) length);
